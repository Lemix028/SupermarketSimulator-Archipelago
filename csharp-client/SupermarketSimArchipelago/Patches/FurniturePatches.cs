...
namespace SupermarketSimArchipelago
{
    ...
    public static class FurnitureUiHelper
    {
        public static void ForceArchipelagoVisuals(FurnitureSalesItem item)
        {
            ...
            //var allTMPs = item.GetComponentsInChildren<TMP_Text>(true);
            //foreach (var tmp in allTMPs)
            //{
            //    if (tmp != null && tmp.GetComponentInParent<UnityEngine.UI.Button>() == null)
            //    {
            ...
            //Plugin.Log.LogInfo($"[Archipelago] ID: {furnitureID} | Name: \"{furnitureName}\"");
