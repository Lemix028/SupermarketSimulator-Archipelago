...
{
    // ==========================================
    // LEVEL REQUIREMENT BYPASS (1-INDEXED)
    // ==========================================
    ...
    // ==========================================
    // SECURITY & LEVEL SPOOFING DURING PURCHASE
    // ==========================================
    ...
    public class UpgradePurchaseBlockerPatch
    {
        ...
        public static bool Prefix(GrowthSectionItem __instance)
        {
            ...
            // Spoof level to pass native internal Purchase() checks
        ...
        {
            // Reset spoofed level immediately
